...
<html lang="en-us">
	<head>
		<meta charset="utf-8">
		<base href="/new">
		<title>PalmerStudios: Forum: Under Construction</title>
		...
		<div class="holder">
			<nav class="topBar">
				<ul class="navTopBar">
					...
					<li class="nav current" title="Ask Questions">
			...
			<article title="Under Construction" class="mainPage">
				<h1 class="articleTitle" title="Under Construction">Forum: Under Construction</h1>
				<p class="article" title="Under Construction">
				This page is currently being built.
				Please bear with us as we update the site.
				</p>
			</article>
			<footer>
				<nav class="footer">
