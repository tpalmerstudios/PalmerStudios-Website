...
<html lang="en-us">
	<head>
		<meta charset="utf-8">
		<base href="/new">
		<title>PalmerStudios: Portfolio</title>
		...
		<div class="holder">
			<nav class="topBar">
				<ul class="navTopBar">
					...
					<li class="current nav" title="See Our Work">
			...
			<article title="PalmerStudios" class="mainPage">
				<h1 class="articleTitle" title="PalmerStudios">Our Portfolio</h1>
				<p class="article" title="PalmerStudios">
				We are constantly working to learn more and provide higher quality services for you.
				These are some samples of our work.
				</p>
			</article>
			<footer>
				<nav class="footer">
					<ul>
						...
						<li>
							<a href="/new/copyright.php">Copyright &copy; Timothy Palmer 2016</a>
						</li>
						<li>
