...
<html lang="en-us">
	<head>
		<meta charset="utf-8">
		<base href="/new">
		<title>PalmerStudios: Site Map</title>
		...
		<div class="holder">
			<nav class="topBar">
				<ul class="navTopBar">
					...
					<li class="current nav" title="More Information">
						<a href="/new/more/">More</a>
					</li>
				</ul>
			</nav>
			<article title="PalmerStudios" class="mainPage">
				<h1 class="articleTitle" title="PalmerStudios">Site Map</h1>
				<p class="article" title="PalmerStudios">
				Will add a site map ASAP. Hope you will bear with me. Will work on the more important aspects first.
				</p>
			</article>
			<footer>
				<nav class="footer">
