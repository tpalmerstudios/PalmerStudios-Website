...
<html lang="en-us">
	<head>
		<meta charset="utf-8">
		<base href="/new">
		<title>PalmerStudios: Learn: Under Construction</title>
		...
		<div class="holder">
			<nav class="topBar">
				<ul class="navTopBar">
					...
					<li class="nav current" title="Learn Stuff">
			...
			<article title="Under Construction" class="mainPage">
				<h1 class="articleTitle" title="Under Construction">Learn: Under Construction</h1>
